  ...
  extends WebView
{
    ...
    extends WebViewClient
  {
    ...
    public void onPageFinished(WebView paramWebView, final String paramString)
    {
      ...
      ((Cocos2dxActivity)Cocos2dxWebView.this.getContext()).runOnGLThread(new Runnable()
      {
        public void run()
        {
          Cocos2dxWebViewHelper._didFinishLoading(Cocos2dxWebView.this.mViewTag, paramString);
        }
      });
    }
    
    public void onReceivedError(WebView paramWebView, int paramInt, String paramString1, final String paramString2)
    {
      ...
      ((Cocos2dxActivity)Cocos2dxWebView.this.getContext()).runOnGLThread(new Runnable()
      {
        public void run()
        {
          Cocos2dxWebViewHelper._didFailLoading(Cocos2dxWebView.this.mViewTag, paramString2);
        }
      });
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView paramWebView, final String paramString)
    {
      ...
      try
      {
        ...
        {
          paramWebView.runOnGLThread(new Runnable()
          {
            public void run()
            {
              Cocos2dxWebViewHelper._onJsCallback(Cocos2dxWebView.this.mViewTag, paramString);
            }
          });
          return true;
        }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\org\cocos2dx\lib\Cocos2dxWebView.class
