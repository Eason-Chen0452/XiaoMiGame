    ...
    extends android.support.v4.app.Fragment
  {
    ...
    public void onEventMainThread(ThrowableFailureEvent paramThrowableFailureEvent)
    {
      ...
      do
      {
        ...
        paramThrowableFailureEvent = (android.support.v4.app.DialogFragment)ErrorDialogManager.factory.prepareErrorFragment(paramThrowableFailureEvent, this.finishAfterDialog, this.argumentsForErrorDialog);
      } while (paramThrowableFailureEvent == null);
      paramThrowableFailureEvent.show(localFragmentManager, "de.greenrobot.eventbus.error_dialog");
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\org\greenrobot\eventbus\util\ErrorDialogManager.class
