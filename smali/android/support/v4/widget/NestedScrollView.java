  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.mEdgeGlowTop != null)
    {
      ...
      if (!this.mEdgeGlowBottom.isFinished())
      {
        ...
        n = getHeight();
        j = 0;
        i1 = Math.max(getScrollRange(), i2) + n;
        if (Build.VERSION.SDK_INT >= 21)
        {
          i = k;
          if (!getClipToPadding()) {}
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\android\support\v4\widget\NestedScrollView.class
