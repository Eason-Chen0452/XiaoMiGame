    ...
    private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle paramBundle)
    {
      ...
      for (;;)
      {
        ...
        for (i = 0;; i = 0)
        {
          ...
          localPendingIntent1 = (PendingIntent)paramBundle.getParcelable("on_read");
          localPendingIntent2 = (PendingIntent)paramBundle.getParcelable("on_reply");
        ...
        if (this.mBuilder.mActions != null)
        {
          ...
          if (n > 0)
          {
            ...
            for (;;)
            {
              ...
              RemoteViews localRemoteViews2 = generateActionButton((NotificationCompat.Action)this.mBuilder.mActions.get(j));
  ...
  public static abstract class Style
  {
    ...
    private Bitmap createColoredBitmap(int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      for (;;)
      {
        ...
        localDrawable.setBounds(0, 0, paramInt1, paramInt3);
        if (paramInt2 != 0) {
    ...
    public RemoteViews applyStandardTemplate(boolean paramBoolean1, int paramInt, boolean paramBoolean2)
    {
      ...
      if (this.mBuilder.getPriority() < -1)
      {
        ...
        if ((paramBoolean1) && (this.mBuilder.mNotification.icon != 0))
        {
          ...
          j = localResources.getDimensionPixelSize(R.dimen.notification_small_icon_background_padding);
          if (Build.VERSION.SDK_INT < 21) {
            break label641;
          }
          localObject = createIconWithBackground(this.mBuilder.mNotification.icon, paramInt, paramInt - j * 2, this.mBuilder.getColor());
      ...
      for (paramInt = 0;; paramInt = 8)
      {
        ...
        if (Build.VERSION.SDK_INT >= 21)
        {
          ...
          int m = localResources.getDimensionPixelSize(R.dimen.notification_small_icon_size_as_large);
          localObject = createIconWithBackground(this.mBuilder.mNotification.icon, paramInt - j, m, this.mBuilder.getColor());
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\android\support\v4\app\NotificationCompat.class
