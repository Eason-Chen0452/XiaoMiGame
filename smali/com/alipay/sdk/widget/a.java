...
public final class a
{
    ...
    extends AlertDialog
  {
    ...
    private static Drawable a(Context paramContext, String paramString)
    {
      ...
      //   3: dup
      //   4: aload_1
      //   5: invokestatic 50	com/alipay/sdk/encrypt/a:a	(Ljava/lang/String;)[B
      //   8: invokespecial 53	java/io/ByteArrayInputStream:<init>	([B)V
      //   11: astore_1
      //   12: new 55	android/graphics/BitmapFactory$Options
      //   15: dup
      //   16: invokespecial 58	android/graphics/BitmapFactory$Options:<init>	()V
      //   19: astore_2
      //   20: aload_2
      //   21: sipush 480
      ...
      //   51: dup
      //   52: aload_0
      //   53: invokevirtual 38	android/content/Context:getResources	()Landroid/content/res/Resources;
      //   56: aload_2
      //   57: invokespecial 79	android/graphics/drawable/BitmapDrawable:<init>	(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V
      //   60: astore_0
      //   61: aload_1
      ...
      //   71: ifnull +42 -> 113
      //   74: aload_0
      //   75: invokevirtual 84	java/io/InputStream:close	()V
      //   78: aconst_null
      //   79: areturn
      //   80: astore_0
      //   81: aconst_null
      ...
      //   87: ifnull +7 -> 94
      //   90: aload_1
      //   91: invokevirtual 84	java/io/InputStream:close	()V
      //   94: aload_0
      //   95: athrow
      //   96: astore_1
      //   97: aload_0
    ...
    private View a(Context paramContext)
    {
      ...
      Object localObject = new FrameLayout.LayoutParams(-2, a(paramContext, 50.0F));
      ((FrameLayout.LayoutParams)localObject).gravity = 17;
      localLinearLayout.setOrientation(0);
      localLinearLayout.setLayoutParams((ViewGroup.LayoutParams)localObject);
      localObject = new GradientDrawable();
      ((GradientDrawable)localObject).setColor(-450944201);
      ((GradientDrawable)localObject).setCornerRadius(a(paramContext, 5.0F));
      localLinearLayout.setBackgroundDrawable((Drawable)localObject);
      ImageView localImageView = new ImageView(paramContext);
      localObject = new LinearLayout.LayoutParams(a(paramContext, 20.0F), a(paramContext, 20.0F));
      ((LinearLayout.LayoutParams)localObject).gravity = 16;
      ((LinearLayout.LayoutParams)localObject).setMargins(a(a.a(a.this), 17.0F), a(a.a(a.this), 10.0F), a(a.a(a.this), 8.0F), a(a.a(a.this), 10.0F));
      localImageView.setLayoutParams((ViewGroup.LayoutParams)localObject);
      localImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
      localImageView.setImageDrawable(a(paramContext, a.d));
      localObject = new RotateAnimation(0.0F, 359.0F, 1, 0.5F, 1, 0.5F);
      ((Animation)localObject).setRepeatCount(-1);
      ((Animation)localObject).setDuration(900L);
      ...
      for (localObject = "正在加载";; localObject = a.b(a.this))
      {
        ...
        ((LinearLayout.LayoutParams)localObject).gravity = 16;
        ((LinearLayout.LayoutParams)localObject).setMargins(0, 0, a(paramContext, 17.0F), 0);
    ...
    protected final void onCreate(Bundle paramBundle)
    {
      ...
      localImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
      localImageView.setImageDrawable(a(localContext, a.d));
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\alipay\sdk\widget\a.class
