...
public final class f
{
  ...
  public static String a(Object paramObject)
  {
    ...
    if (com.alipay.a.b.a.a(paramObject.getClass())) {
      return org.json.alipay.b.c(paramObject.toString());
    }
    if (Collection.class.isAssignableFrom(paramObject.getClass())) {
      return new org.json.alipay.a((List)paramObject).toString();
    }
    if (Map.class.isAssignableFrom(paramObject.getClass())) {
      return new org.json.alipay.b((Map)paramObject).toString();
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\alipay\a\a\f.class
