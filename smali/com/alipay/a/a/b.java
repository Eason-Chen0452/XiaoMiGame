  ...
  implements i, j
{
  ...
  public final Object a(Object paramObject, Type paramType)
  {
    ...
    Object localObject = com.alipay.a.b.a.a(paramType);
    paramObject = (org.json.alipay.a)paramObject;
    localObject = a((Class)localObject, paramType);
    if ((paramType instanceof ParameterizedType))
    {
      paramType = ((ParameterizedType)paramType).getActualTypeArguments()[0];
      while (i < ((org.json.alipay.a)paramObject).a())
      {
        ((Collection)localObject).add(e.a(((org.json.alipay.a)paramObject).a(i), paramType));
        i += 1;
      }
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\alipay\a\a\b.class
