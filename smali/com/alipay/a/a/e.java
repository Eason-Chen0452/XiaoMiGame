...
public final class e
{
  ...
  public static final Object a(String paramString, Type paramType)
  {
    ...
    if ((paramString.startsWith("[")) && (paramString.endsWith("]"))) {
      return a(new org.json.alipay.a(paramString), paramType);
    }
    if ((paramString.startsWith("{")) && (paramString.endsWith("}"))) {
      return a(new org.json.alipay.b(paramString), paramType);
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\alipay\a\a\e.class
