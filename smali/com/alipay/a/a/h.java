  ...
  implements i, j
{
  ...
  public final Object a(Object paramObject, Type paramType)
  {
    ...
    if ((paramType instanceof ParameterizedType))
    {
      ...
      {
        localObject = ((b)paramObject).a();
        while (((Iterator)localObject).hasNext())
        {
          String str = (String)((Iterator)localObject).next();
          if (a.a((Class)paramType)) {
            localMap.put(str, ((b)paramObject).a(str));
          } else {
            localMap.put(str, e.a(((b)paramObject).a(str), paramType));
          }
        }
      }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\alipay\a\a\h.class
