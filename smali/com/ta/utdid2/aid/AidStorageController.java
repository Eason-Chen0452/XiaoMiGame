...
public class AidStorageController
{
  ...
  private static String getEncodedAppName(String paramString1, String paramString2)
  {
    ...
    for (paramString1 = Base64Helper.encodeToString(paramString1.concat(paramString2).getBytes(), 2);; paramString1 = Base64.encodeToString(paramString1.concat(paramString2).getBytes(), 2))
    {
      if (DebugUtils.DBG) {
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\ta\utdid2\aid\AidStorageController.class
