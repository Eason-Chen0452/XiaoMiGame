...
.method public open(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .line 70
    .local v6, "thumbnailUri":Landroid/net/Uri;
    const/4 v3, 0x0

    .line 72
    .local v3, "inputStream":Ljava/io/InputStream;
    iget-object v8, p0, Lcom/bumptech/glide/load/data/mediastore/ThumbnailStreamOpener;->query:Lcom/bumptech/glide/load/data/mediastore/ThumbnailQuery;

    invoke-interface {v8, p1}, Lcom/bumptech/glide/load/data/mediastore/ThumbnailQuery;->query(Landroid/net/Uri;)Landroid/database/Cursor;
    ...
    :cond_4
    :try_start_2
    iget-object v7, p0, Lcom/bumptech/glide/load/data/mediastore/ThumbnailStreamOpener;->service:Lcom/bumptech/glide/load/data/mediastore/FileService;

    invoke-virtual {v7, v5}, Lcom/bumptech/glide/load/data/mediastore/FileService;->get(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v7, v2}, Lcom/bumptech/glide/load/data/mediastore/FileService;->exists(Ljava/io/File;)Z
    ...
    invoke-virtual {v7, v2}, Lcom/bumptech/glide/load/data/mediastore/FileService;->length(Ljava/io/File;)J
    ...
    .line 93
    :try_start_3
    iget-object v7, p0, Lcom/bumptech/glide/load/data/mediastore/ThumbnailStreamOpener;->contentResolver:Landroid/content/ContentResolver;
    ...
    const-string v9, "NPE opening uri: "
    ...
    .line 97
    invoke-virtual {v7, v1}, Ljava/io/FileNotFoundException;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;

    move-result-object v7

    check-cast v7, Ljava/io/FileNotFoundException;
