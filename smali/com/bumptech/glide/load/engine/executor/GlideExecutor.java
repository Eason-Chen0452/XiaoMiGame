  ...
  extends ThreadPoolExecutor
{
  ...
  public static int calculateBestThreadCount()
  {
    ...
    try
    {
      File[] arrayOfFile = new File("/sys/devices/system/cpu/").listFiles(new FilenameFilter()
      {
        ...
        {
          return this.val$cpuNamePattern.matcher(paramAnonymousString).matches();
        }
      });
  ...
  private <T> Future<T> maybeWait(Future<T> paramFuture)
  {
    ...
    //   8: istore_2
    //   9: aload_1
    //   10: invokeinterface 162 1 0
    //   15: istore_3
    //   16: iload_3
    //   17: ifne +43 -> 60
    //   20: aload_1
    //   21: invokeinterface 166 1 0
    //   26: pop
    //   27: goto -18 -> 9
    //   30: astore_1
    //   31: new 168	java/lang/RuntimeException
    //   34: dup
    //   35: aload_1
    //   36: invokespecial 171	java/lang/RuntimeException:<init>	(Ljava/lang/Throwable;)V
    //   39: athrow
    //   40: astore_1
    //   41: iload_2
    //   42: ifeq +9 -> 51
    //   45: invokestatic 177	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   48: invokevirtual 180	java/lang/Thread:interrupt	()V
    //   51: aload_1
    //   52: athrow
    //   53: astore 4
    //   55: iconst_1
    ...
    //   60: iload_2
    //   61: ifeq +9 -> 70
    //   64: invokestatic 177	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   67: invokevirtual 180	java/lang/Thread:interrupt	()V
    //   70: aload_1
    //   71: areturn
    ...
    implements ThreadFactory
  {
    ...
    public Thread newThread(@NonNull Runnable paramRunnable)
    {
      try
      {
        paramRunnable = new Thread(paramRunnable, "glide-" + this.name + "-thread-" + this.threadNum)
        {
          public void run()
          {
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\bumptech\glide\load\engine\executor\GlideExecutor.class
