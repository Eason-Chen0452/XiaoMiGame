...
.method cancel()V
    ...
    .line 145
    iget-boolean v2, p0, Lcom/bumptech/glide/load/engine/EngineJob;->hasLoadFailed:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Lcom/bumptech/glide/load/engine/EngineJob;->hasResource:Z
    ...
    invoke-virtual {v2}, Lcom/bumptech/glide/load/engine/DecodeJob;->cancel()V

    .line 151
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/EngineJob;->diskCacheExecutor:Lcom/bumptech/glide/load/engine/executor/GlideExecutor;

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/EngineJob;->decodeJob:Lcom/bumptech/glide/load/engine/DecodeJob;

    invoke-virtual {v2, v3}, Lcom/bumptech/glide/load/engine/executor/GlideExecutor;->remove(Ljava/lang/Runnable;)Z

    move-result v2

    if-nez v2, :cond_2

    iget-object v2, p0, Lcom/bumptech/glide/load/engine/EngineJob;->sourceExecutor:Lcom/bumptech/glide/load/engine/executor/GlideExecutor;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/EngineJob;->sourceUnlimitedExecutor:Lcom/bumptech/glide/load/engine/executor/GlideExecutor;
    ...
    .line 154
    .local v0, "isPendingJobRemoved":Z
    :goto_1
    ...
    .line 153
    .end local v0    # "isPendingJobRemoved":Z
    :cond_3
    const/4 v0, 0x0
