  ...
  implements EngineJobListener, EngineResource.ResourceListener, MemoryCache.ResourceRemovedListener
{
  ...
  public <R> LoadStatus load(GlideContext paramGlideContext, Object paramObject, Key paramKey, int paramInt1, int paramInt2, Class<?> paramClass, Class<R> paramClass1, Priority paramPriority, DiskCacheStrategy paramDiskCacheStrategy, Map<Class<?>, Transformation<?>> paramMap, boolean paramBoolean1, Options paramOptions, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, ResourceCallback paramResourceCallback)
  {
    ...
    paramGlideContext = this.decodeJobFactory.build(paramGlideContext, paramObject, localEngineKey, paramKey, paramInt1, paramInt2, paramClass, paramClass1, paramPriority, paramDiskCacheStrategy, paramMap, paramBoolean1, paramBoolean4, paramOptions, (DecodeJob.Callback)localObject);
  ...
  static class DecodeJobFactory
  {
    ...
    <R> DecodeJob<R> build(GlideContext paramGlideContext, Object paramObject, EngineKey paramEngineKey, Key paramKey, int paramInt1, int paramInt2, Class<?> paramClass, Class<R> paramClass1, Priority paramPriority, DiskCacheStrategy paramDiskCacheStrategy, Map<Class<?>, Transformation<?>> paramMap, boolean paramBoolean1, boolean paramBoolean2, Options paramOptions, DecodeJob.Callback<R> paramCallback)
    {
      DecodeJob localDecodeJob = (DecodeJob)this.pool.acquire();
      int i = this.creationOrder;
      this.creationOrder = (i + 1);
      return localDecodeJob.init(paramGlideContext, paramObject, paramEngineKey, paramKey, paramInt1, paramInt2, paramClass, paramClass1, paramPriority, paramDiskCacheStrategy, paramMap, paramBoolean1, paramBoolean2, paramOptions, paramCallback, i);
    }
  }
    ...
    implements MessageQueue.IdleHandler
  {
    ...
    public boolean queueIdle()
    {
      ...
      if (localResourceWeakReference != null) {
        this.activeResources.remove(localResourceWeakReference.key);
      }
      return true;
    }
  }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\bumptech\glide\load\engine\Engine.class
