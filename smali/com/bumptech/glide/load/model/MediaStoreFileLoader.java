    ...
    implements DataFetcher<File>
  {
    ...
    public void loadData(Priority paramPriority, DataFetcher.DataCallback<? super File> paramDataCallback)
    {
      ...
      try
      {
        ...
        {
          paramDataCallback.onLoadFailed(new FileNotFoundException("Failed to find file path for: " + this.uri));
          return;
        }
      }
      finally
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\bumptech\glide\load\model\MediaStoreFileLoader.class
