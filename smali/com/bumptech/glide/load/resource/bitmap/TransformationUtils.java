...
public final class TransformationUtils
{
  ...
  static
  {
    ...
    MODELS_REQUIRING_BITMAP_LOCK = Arrays.asList(new String[] { "XT1097", "XT1085" });
    if ((MODELS_REQUIRING_BITMAP_LOCK.contains(Build.MODEL)) && (Build.VERSION.SDK_INT == 22)) {}
    for (Object localObject = new ReentrantLock();; localObject = new NoLock())
    {
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\bumptech\glide\load\resource\bitmap\TransformationUtils.class
