...
class GifFrameLoader
{
  ...
  {
    return paramRequestManager.asBitmap().apply(RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.NONE).skipMemoryCache(true).override(paramInt1, paramInt2));
  }
  ...
  void setNextStartFromFirstFrame()
  {
    ...
    {
      Preconditions.checkArgument(bool, "Can't restart a running animation");
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\bumptech\glide\load\resource\gif\GifFrameLoader.class
