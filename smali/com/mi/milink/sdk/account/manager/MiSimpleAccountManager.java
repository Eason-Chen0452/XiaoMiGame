...
public class MiSimpleAccountManager
{
  ...
  private String TAG = MiSimpleAccountManager.class.getSimpleName();
  int appId;
  ...
  public MiSimpleAccountManager(EventBus paramEventBus, int paramInt)
  {
  ...
  {
    MiLinkLog.d(this.TAG, "switchAccountTypeMode turn to " + paramInt);
    switch (paramInt)
    {
    default: 
      return;
  ...
  public void login(String paramString1, String paramString2, String paramString3, byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        MiLinkLog.w(this.TAG, str1 + " passportInit:" + paramBoolean);
        ...
        MiLinkLog.d(this.TAG, "b2Token=" + str4);
  ...
  public void setMipushRegId(String paramString)
  {
    try
    {
      MiLinkLog.v(this.TAG, "setMiPushRegId:" + paramString);
  ...
  {
    MiLinkLog.w(this.TAG, "setPassportInit b=" + paramBoolean);
    this.mPassportInit = paramBoolean;
  }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\mi\milink\sdk\account\manager\MiSimpleAccountManager.class
