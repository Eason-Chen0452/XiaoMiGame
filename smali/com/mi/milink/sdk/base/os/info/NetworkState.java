...
public class NetworkState
{
  ...
  public static NetworkState fromNetworkInfo(NetworkInfo paramNetworkInfo)
  {
    ...
    localNetworkState.setAvailable(paramNetworkInfo.isAvailable());
    ...
    default: 
      ...
      localNetworkState.setApnType(-1);
    case 1: 
    case 9: 
      for (;;)
      {
        ...
        localNetworkState.setApnType(-1);
        continue;
        localNetworkState.setType(NetworkType.ETHERNET);
        localNetworkState.setApnType(-1);
      }
    }
    ...
    for (NetworkType localNetworkType = NetworkType.MOBILE_3G;; localNetworkType = NetworkType.MOBILE_2G)
    {
      ...
      localNetworkState.setApnType(paramNetworkInfo.getSubtype());
      break;
    }
  }
  ...
  private static boolean is4GMobileType(int paramInt)
  {
    return getNetworkClass(paramInt) == 3;
  }
  ...
  public void setApnType(int paramInt)
  {
    this.apnType = paramInt;
  }
  ...
  {
    if (this.apnName != null) {
      return "NetworkState [connected=" + this.connected + ", apnName=" + new String(Base64.encode(this.apnName.getBytes(), 0)) + ", type=" + this.type + ", accessPoint=" + this.accessPoint + "]";
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\mi\milink\sdk\base\os\info\NetworkState.class
