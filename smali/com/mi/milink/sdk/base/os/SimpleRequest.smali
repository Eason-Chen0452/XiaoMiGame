.class public final Lcom/mi/milink/sdk/base/os/SimpleRequest;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/mi/milink/sdk/base/os/SimpleRequest$StreamContent;,
        Lcom/mi/milink/sdk/base/os/SimpleRequest$MapContent;,
        Lcom/mi/milink/sdk/base/os/SimpleRequest$StringContent;,
        Lcom/mi/milink/sdk/base/os/SimpleRequest$HeaderContent;,
        Lcom/mi/milink/sdk/base/os/SimpleRequest$LengthPair;
    }
.end annotation
...
.method protected static makeConn(Ljava/lang/String;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    invoke-static {v2, v0}, Lcom/mi/milink/sdk/debug/MiLinkLog;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, v3}, Lcom/mi/milink/sdk/base/os/SimpleRequest;->joinMap(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method public static postAsString(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;ZLcom/mi/milink/sdk/base/os/SimpleRequest$LengthPair;)Lcom/mi/milink/sdk/base/os/SimpleRequest$StringContent;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static postAsString(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;ZLjava/lang/String;Lcom/mi/milink/sdk/base/os/SimpleRequest$LengthPair;)Lcom/mi/milink/sdk/base/os/SimpleRequest$StringContent;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lcom/mi/milink/sdk/base/os/SimpleRequest;->makeConn(Ljava/lang/String;Ljava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    invoke-virtual {v7, v0, p4}, Ljava/net/HttpURLConnection;->addRequestProperty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/mi/milink/sdk/base/os/SimpleRequest;->mapToPairs(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-static {v1}, Lcom/mi/milink/sdk/util/compress/CompressionFactory;->createCompression(I)Lcom/mi/milink/sdk/util/compress/ICompression;

    move-result-object v1

    invoke-interface {v1, v0}, Lcom/mi/milink/sdk/util/compress/ICompression;->compress([B)[B
    ...
    iput v0, p5, Lcom/mi/milink/sdk/base/os/SimpleRequest$LengthPair;->originLength:I

    array-length v0, v1

    iput v0, p5, Lcom/mi/milink/sdk/base/os/SimpleRequest$LengthPair;->compressLength:I
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-virtual {v9, v0, v8}, Ljava/net/CookieManager;->put(Ljava/net/URI;Ljava/util/Map;)V
    ...
    invoke-static {v4, v1}, Lcom/mi/milink/sdk/debug/MiLinkLog;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :goto_3
    :try_start_7
    new-instance v1, Lcom/mi/milink/sdk/base/os/SimpleRequest$StringContent;

    invoke-virtual {v2}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/mi/milink/sdk/base/os/SimpleRequest$StringContent;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/mi/milink/sdk/base/os/SimpleRequest;->parseCookies(Ljava/util/List;)Ljava/util/Map;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/mi/milink/sdk/base/os/SimpleRequest$StringContent;->putCookies(Ljava/util/Map;)V

    invoke-static {v8}, Lcom/mi/milink/sdk/base/os/SimpleRequest;->listToMap(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v2

    invoke-interface {v0, v2}, Ljava/util/Map;->putAll(Ljava/util/Map;)V

    invoke-virtual {v1, v0}, Lcom/mi/milink/sdk/base/os/SimpleRequest$StringContent;->putHeaders(Ljava/util/Map;)V
    :try_end_7
...
.method public static postAsStringByHttps(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;ZLjava/lang/String;Lcom/mi/milink/sdk/base/os/SimpleRequest$LengthPair;)Lcom/mi/milink/sdk/base/os/SimpleRequest$StringContent;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
