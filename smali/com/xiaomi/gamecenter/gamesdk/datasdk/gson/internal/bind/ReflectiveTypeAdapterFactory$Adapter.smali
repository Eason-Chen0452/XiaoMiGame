.class public final Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;
.super Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/TypeAdapter;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory;
.end annotation
...
# direct methods
.method constructor <init>(Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/ObjectConstructor;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->constructor:Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/ObjectConstructor;

    iput-object p2, p0, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->boundFields:Ljava/util/Map;
...
.method public final read(Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/stream/JsonReader;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->constructor:Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/ObjectConstructor;
    ...
    iget-object v2, p0, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->boundFields:Ljava/util/Map;

    invoke-interface {v2, v0}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;

    if-eqz v0, :cond_1

    iget-boolean v2, v0, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->deserialized:Z
    ...
    :cond_2
    :try_start_1
    invoke-virtual {v0, p1, v1}, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->read(Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/stream/JsonReader;Ljava/lang/Object;)V
    :try_end_1
...
.method public final write(Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter;->boundFields:Ljava/util/Map;
    ...
    invoke-virtual {v0, p2}, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->writeField(Ljava/lang/Object;)Z

    move-result v2

    if-eqz v2, :cond_1

    iget-object v2, v0, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->name:Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2}, Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField;->write(Lcom/xiaomi/gamecenter/gamesdk/datasdk/gson/stream/JsonWriter;Ljava/lang/Object;)V
    :try_end_0
