  ...
  private static Type resolve(Type paramType1, Class<?> paramClass, Type paramType2, Collection<TypeVariable> paramCollection)
  {
    ...
    if ((localObject1 instanceof ParameterizedType))
    {
      ...
      if (localObject3 != paramType2)
      {
        ...
        paramType2 = resolve(paramType1, paramClass, localObject1[j], paramCollection);
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\xiaomi\gamecenter\gamesdk\datasdk\gson\internal\$Gson$Types.class
