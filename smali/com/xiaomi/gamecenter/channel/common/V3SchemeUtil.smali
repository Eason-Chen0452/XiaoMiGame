.class public Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;
...
.method public static containV2Signature(Ljava/io/File;Z)Z
    ...
    :try_start_0
    invoke-static {p0}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->getApkSigningBlock(Ljava/io/File;)Ljava/nio/ByteBuffer;

    move-result-object v0

    invoke-static {v0}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->getAllIdValue(Ljava/nio/ByteBuffer;)Ljava/util/Map;
    ...
    .catch Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier$SignatureNotFoundException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-virtual {v0}, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier$SignatureNotFoundException;->printStackTrace()V
...
.method public static findCentralDir(Ljava/io/RandomAccessFile;JI)Lcom/xiaomi/gamecenter/channel/common/Pair;
    ...
    invoke-static {p0, p1, p2, p3}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->getByteBuffer(Ljava/io/RandomAccessFile;JI)Ljava/nio/ByteBuffer;
...
.method public static findContentEntry(Ljava/io/RandomAccessFile;I)Lcom/xiaomi/gamecenter/channel/common/Pair;
    ...
    invoke-static {p0, v2, v3, p1}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->getByteBuffer(Ljava/io/RandomAccessFile;JI)Ljava/nio/ByteBuffer;
...
.method public static getAllIdValue(Ljava/nio/ByteBuffer;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier;->checkByteOrderLittleEndian(Ljava/nio/ByteBuffer;)V
    ...
    new-instance v1, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier$SignatureNotFoundException;
    ...
    invoke-direct {v1, v0}, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier$SignatureNotFoundException;-><init>(Ljava/lang/String;)V
...
.method public static getApkSectionInfo(Ljava/io/File;)Lcom/xiaomi/gamecenter/channel/common/ApkSectionInfo;
    ...
    invoke-static {v2}, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier;->getEocd(Ljava/io/RandomAccessFile;)Lcom/xiaomi/gamecenter/channel/common/Pair;
    ...
    :cond_0
    invoke-static {v0, v4, v5}, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier;->getCentralDirOffset(Ljava/nio/ByteBuffer;J)J

    move-result-wide v0

    invoke-static {v2, v0, v1}, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier;->findApkSigningBlock(Ljava/io/RandomAccessFile;J)Lcom/xiaomi/gamecenter/channel/common/Pair;
    ...
    invoke-static {v2, v0, v1, v4}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->findCentralDir(Ljava/io/RandomAccessFile;JI)Lcom/xiaomi/gamecenter/channel/common/Pair;
    ...
    invoke-static {v2, v0}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->findContentEntry(Ljava/io/RandomAccessFile;I)Lcom/xiaomi/gamecenter/channel/common/Pair;
...
.method public static getHashWithoutChannel(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v4}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->getApkSectionInfo(Ljava/io/File;)Lcom/xiaomi/gamecenter/channel/common/ApkSectionInfo;
    ...
    invoke-static {v4}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->getAllIdValue(Ljava/nio/ByteBuffer;)Ljava/util/Map;
    ...
    new-instance v4, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier$SignatureNotFoundException;

    const-string v5, "No APK V3 Signature Scheme block in APK Signing Block"

    invoke-direct {v4, v5}, Lcom/xiaomi/gamecenter/channel/common/verify/ApkSignatureSchemeV3Verifier$SignatureNotFoundException;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->generateApkSigningBlock(Ljava/util/Map;)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v4}, Lcom/xiaomi/gamecenter/channel/common/V3SchemeUtil;->intToByteArray(I)[B
