...
public class V2SchemeUtil
{
  ...
  public static boolean containV2Signature(File paramFile, boolean paramBoolean)
  {
    try
    {
      boolean bool = getAllIdValue(getApkSigningBlock(paramFile)).containsKey(Integer.valueOf(1896449818));
      if (bool) {
        return true;
      }
    }
    ...
    throws IOException, ApkSignatureSchemeV2Verifier.SignatureNotFoundException
  {
    ...
    paramFile = ApkSignatureSchemeV2Verifier.getEocd((RandomAccessFile)localObject2);
    ...
    long l2 = ApkSignatureSchemeV2Verifier.getCentralDirOffset((ByteBuffer)localObject1, l1);
    localObject1 = ApkSignatureSchemeV2Verifier.findApkSigningBlock((RandomAccessFile)localObject2, l2);
  ...
  public static ByteBuffer getApkSigningBlock(File paramFile)
    throws ApkSignatureSchemeV2Verifier.SignatureNotFoundException, IOException
  {
    ...
    return (ByteBuffer)ApkSignatureSchemeV2Verifier.findApkSigningBlock(paramFile, ApkSignatureSchemeV2Verifier.getCentralDirOffset(localByteBuffer, l)).getFirst();
  }
  ...
  public static String getHashWithoutChannel(String paramString1, String paramString2)
    throws IOException, NoSuchAlgorithmException, ApkSignatureSchemeV2Verifier.SignatureNotFoundException
  {
    ...
    if (!((Map)localObject2).containsKey(Integer.valueOf(1896449818))) {
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\xiaomi\gamecenter\channel\common\V2SchemeUtil.class
