...
final class a
  implements Runnable
{
  a(MiAppEntry paramMiAppEntry, String paramString1, String paramString2, String paramString3, String paramString4) {}
  ...
  public final void run()
  {
    try
    {
      ...
      DataSDK.eventClick(ReportData.d(), ReportData.f(), ReportData.e(), this.i);
      Logger.a("MiGameSDK.ReportData", "the statistic event info is CLICK " + ReportData.d().getName() + " " + ReportData.e().getName());
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\xiaomi\gamecenter\sdk\report\a.class
