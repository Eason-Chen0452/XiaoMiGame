package com.xiaomi.gson.internal.bind.util;
        ...
        if (a(paramString, i, ':'))
        {
          ...
          if (paramString.length() > i)
          {
            ...
            if ((j != 90) && (j != 43) && (j != 45))
            {
              ...
              {
                k += 1;
                i1 = a(paramString, k + 1);
                i5 = Math.min(i1, k + 3);
                j = a(paramString, k, i5);
                switch (i5 - k)
                {
                case 2: 
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\xiaomi\gson\internal\bind\util\ISO8601Utils.class
