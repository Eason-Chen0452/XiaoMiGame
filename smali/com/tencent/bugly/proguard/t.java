...
public final class t
{
  ...
  private void a(Runnable paramRunnable, boolean paramBoolean, long paramLong)
  {
    ...
    for (;;)
    {
      synchronized (this.p)
      {
        ...
        if (paramBoolean)
        {
          a(new a(this.c, paramRunnable, paramLong), 0L);
          return;
        }
      }
      a(paramRunnable);
      localv.c(new a(this.c));
      continue;
      label287:
      a(paramRunnable);
    }
  ...
  public final long a(int paramInt)
  {
    ...
    //   3: iflt +43 -> 46
    //   6: aload_0
    //   7: getfield 51	com/tencent/bugly/proguard/t:d	Ljava/util/Map;
    //   10: iload_1
    //   11: invokestatic 148	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   14: invokeinterface 318 2 0
    //   19: checkcast 245	java/lang/Long
    //   22: astore 4
    //   24: aload 4
    //   26: ifnonnull +11 -> 37
    //   29: ldc2_w 342
    ...
    //   36: lreturn
    //   37: aload 4
    //   39: invokevirtual 346	java/lang/Long:longValue	()J
    //   42: lstore_2
    //   43: goto -10 -> 33
    //   46: ldc_w 348
    //   49: iconst_1
    ...
    //   54: iconst_0
    //   55: iload_1
    //   56: invokestatic 148	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   59: aastore
    //   60: invokestatic 178	com/tencent/bugly/proguard/w:e	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   63: pop
    //   64: ldc2_w 342
    //   67: lstore_2
    //   68: goto -35 -> 33
  ...
  public final long b()
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      try
      {
        localObject = (q)localList.get(0);
        l2 = l3;
        l1 = l3;
        if (((q)localObject).e >= l4)
        {
          l1 = l3;
          l2 = a.c(((q)localObject).g);
          l1 = l2;
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\tencent\bugly\proguard\t.class
