...
public final class o
{
  ...
  private int a(String paramString1, String paramString2, String[] paramArrayOfString, n paramn)
  {
    ...
    //   33	40	6	j	int
    //   1	70	7	k	int
    //   14	8	8	localSQLiteDatabase	SQLiteDatabase
    // Exception table:
    //   from	to	target	type
  ...
  public final List<q> a(int paramInt)
  {
    ...
    //   20: dup
    //   21: ldc_w 304
    //   24: invokespecial 232	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   27: iload_1
    //   28: invokevirtual 235	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   31: invokevirtual 200	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   34: astore 4
    //   36: aload 5
    //   38: ldc -40
    //   40: aconst_null
    ...
    //   45: aconst_null
    //   46: aconst_null
    //   47: invokevirtual 317	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   50: astore 4
    //   52: aload 4
    //   54: ifnonnull +33 -> 87
    //   57: aload 4
    ...
    //   94: astore 7
    //   96: new 325	java/util/ArrayList
    //   99: dup
    //   100: invokespecial 326	java/util/ArrayList:<init>	()V
    //   103: astore 6
    //   105: aload 4
    //   107: invokeinterface 329 1 0
    //   112: ifeq +155 -> 267
    //   115: aload 4
    //   117: invokestatic 375	com/tencent/bugly/proguard/o:a	(Landroid/database/Cursor;)Lcom/tencent/bugly/proguard/q;
    //   120: astore 8
    //   122: aload 8
    //   124: ifnull +55 -> 179
    //   127: aload 6
    //   129: aload 8
    //   131: invokeinterface 335 2 0
    //   136: pop
    //   137: goto -32 -> 105
    //   140: astore 5
    //   142: aload 5
    //   144: invokestatic 52	com/tencent/bugly/proguard/w:a	(Ljava/lang/Throwable;)Z
    //   147: ifne +8 -> 155
    //   150: aload 5
    //   152: invokevirtual 55	java/lang/Throwable:printStackTrace	()V
    //   155: aload 4
    //   157: ifnull +20 -> 177
    //   160: aload 4
    ...
    //   181: aload 4
    //   183: ldc 61
    //   185: invokeinterface 97 2 0
    //   190: invokeinterface 101 2 0
    //   195: lstore_2
    //   196: aload 7
    //   198: ldc -69
    //   200: invokevirtual 191	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   203: ldc -63
    //   205: invokevirtual 191	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   208: lload_2
    //   209: invokevirtual 196	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   212: pop
    //   213: goto -108 -> 105
    //   216: astore 8
    //   218: ldc_w 339
    ...
    //   225: invokestatic 75	com/tencent/bugly/proguard/w:d	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   228: pop
    //   229: goto -124 -> 105
    //   232: astore 6
    //   234: aload 4
    ...
    //   244: ifnull +20 -> 264
    //   247: aload 5
    //   249: invokeinterface 320 1 0
    //   254: ifne +10 -> 264
    //   257: aload 5
    //   259: invokeinterface 323 1 0
    //   264: aload 4
    //   266: athrow
    //   267: aload 7
    //   269: invokevirtual 200	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   272: astore 7
    //   274: aload 7
    //   276: invokevirtual 205	java/lang/String:length	()I
    //   279: ifle +39 -> 318
    //   282: ldc_w 344
    //   285: iconst_2
    ...
    //   300: aload 7
    //   302: iconst_4
    //   303: invokevirtual 208	java/lang/String:substring	(I)Ljava/lang/String;
    //   306: aconst_null
    //   307: invokevirtual 47	android/database/sqlite/SQLiteDatabase:delete	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    //   310: invokestatic 222	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   313: aastore
    //   314: invokestatic 75	com/tencent/bugly/proguard/w:d	(Ljava/lang/String;[Ljava/lang/Object;)Z
    //   317: pop
    //   318: aload 4
    //   320: ifnull +20 -> 340
    //   323: aload 4
    //   325: invokeinterface 320 1 0
    //   330: ifne +10 -> 340
    //   333: aload 4
    //   335: invokeinterface 323 1 0
    //   340: aload 6
    //   342: areturn
    //   343: astore 4
    //   345: aconst_null
    ...
    //   start	length	slot	name	signature
    //   0	372	0	this	o
    //   0	372	1	paramInt	int
    //   195	14	2	l	long
    //   34	300	4	localObject1	Object
    //   343	11	4	localObject2	Object
    //   359	9	4	localObject3	Object
    //   6	31	5	localSQLiteDatabase	SQLiteDatabase
    //   140	11	5	localThrowable1	Throwable
    //   236	120	5	localObject4	Object
    //   364	1	5	localThrowable2	Throwable
    //   103	25	6	localArrayList	java.util.ArrayList
    //   232	109	6	localList	List<q>
    //   351	7	6	localObject5	Object
    //   94	207	7	localObject6	Object
    //   120	10	8	localq	q
    //   216	1	8	localThrowable3	Throwable
    // Exception table:
    //   from	to	target	type
    //   87	105	140	java/lang/Throwable
    //   105	122	140	java/lang/Throwable
    //   127	137	140	java/lang/Throwable
    //   218	229	140	java/lang/Throwable
    //   267	318	140	java/lang/Throwable
    //   179	213	216	java/lang/Throwable
    //   87	105	232	finally
    //   105	122	232	finally
    //   127	137	232	finally
    //   179	213	232	finally
    ...
    //   36	52	343	finally
    //   142	155	351	finally
    //   17	36	364	java/lang/Throwable
    //   36	52	364	java/lang/Throwable
  }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\tencent\bugly\proguard\o.class
