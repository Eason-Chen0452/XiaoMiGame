  ...
  implements MessageLite
{
    ...
    implements MessageLite.Builder
  {
    ...
    public Builder clearField(int paramInt)
    {
      if (paramInt == 0) {
        throw new IllegalArgumentException("Zero is not a valid field number.");
      }
      ...
      if (this.fields.containsKey(Integer.valueOf(paramInt))) {
        this.fields.remove(Integer.valueOf(paramInt));
      }
      return this;
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\protobuf\UnknownFieldSet.class
