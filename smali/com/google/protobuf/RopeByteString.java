  ...
  extends ByteString
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (this.hash != 0)
    {
      int i = ((ByteString)paramObject).peekCachedHashCode();
      if ((i != 0) && (this.hash != i)) {
        return false;
      }
    }
  ...
  public ByteString substring(int paramInt1, int paramInt2)
  {
    ...
    {
      paramInt1 = this.totalLength;
      throw new IndexOutOfBoundsException(36 + "End index: " + paramInt2 + " > " + paramInt1);
    }
  ...
  private static class Balancer
  {
    ...
    private void doBalance(ByteString paramByteString)
    {
      ...
      throw new IllegalArgumentException(paramByteString.length() + 49 + "Has a new type of ByteString been created? Found " + paramByteString);
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\protobuf\RopeByteString.class
