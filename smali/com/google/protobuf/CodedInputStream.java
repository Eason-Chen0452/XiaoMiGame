...
public final class CodedInputStream
{
    ...
    throws IOException
  {
    ...
    i = j + 1;
    long l = arrayOfByte[j] << 7 ^ k;
    if (l < 0L) {
      l ^= 0xFFFFFFFFFFFFFF80;
    }
    for (;;)
    {
      this.bufferPos = i;
  ...
  {
    if (paramInt < 0) {
      throw new IllegalArgumentException(42 + "Size limit cannot be negative: " + paramInt);
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\protobuf\CodedInputStream.class
