...
public final class CodedOutputStream
{
  ...
  {
    return computeRawVarint32Size(paramByteBuffer.capacity()) + paramByteBuffer.capacity();
  }
  ...
  {
    return newInstance(paramByteBuffer, 4096);
  }
  
  public static CodedOutputStream newInstance(ByteBuffer paramByteBuffer, int paramInt)
  {
    return newInstance(new ByteBufferOutputStream(paramByteBuffer), paramInt);
  }
  ...
  private void writeRawBytesInternal(ByteBuffer paramByteBuffer)
    throws IOException
  {
  ...
  {
    writeTag(paramInt, 2);
    writeByteBufferNoTag(paramByteBuffer);
  }
  
  public void writeByteBufferNoTag(ByteBuffer paramByteBuffer)
    throws IOException
  {
    writeRawVarint32(paramByteBuffer.capacity());
    ...
    throws IOException
  {
    ...
    {
      writeRawBytes(paramByteBuffer.array(), paramByteBuffer.arrayOffset(), paramByteBuffer.capacity());
      return;
    }
    paramByteBuffer = paramByteBuffer.duplicate();
    paramByteBuffer.clear();
    writeRawBytesInternal(paramByteBuffer);
  }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\protobuf\CodedOutputStream.class
