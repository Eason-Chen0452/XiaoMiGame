...
public final class Version
{
    ...
    throws FormatException
  {
    ...
    try
    {
      Version localVersion = getVersionForNumber(paramInt - 17 >> 2);
      return localVersion;
    }
  ...
  BitMatrix buildFunctionPattern()
  {
    ...
    localBitMatrix.setRegion(k - 8, 0, 8, 9);
    localBitMatrix.setRegion(0, k - 8, 9, 8);
    ...
    localBitMatrix.setRegion(6, 9, 1, k - 17);
    localBitMatrix.setRegion(9, 6, k - 17, 1);
    if (this.versionNumber > 6)
    {
      localBitMatrix.setRegion(k - 11, 0, 3, 6);
      localBitMatrix.setRegion(0, k - 11, 6, 3);
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\zxing\qrcode\decoder\Version.class
