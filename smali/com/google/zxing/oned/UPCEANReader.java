  ...
  extends OneDReader
{
  ...
  static
  {
    ...
    L_PATTERNS = new int[][] { { 3, 2, 1, 1 }, arrayOfInt1, { 2, 1, 2, 2 }, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, { 1, 3, 1, 2 }, { 1, 2, 1, 3 }, { 3, 1, 1, 2 } };
    ...
    throws NotFoundException, ChecksumException, FormatException
  {
    ...
    try
    {
      ...
      {
        paramBitArray = this.eanManSupport.lookupCountryIdentifier(paramMap);
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\zxing\oned\UPCEANReader.class
