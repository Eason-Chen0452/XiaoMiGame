  ...
  extends AbstractRSSReader
{
  ...
  static
  {
    ...
    WEIGHTS = new int[][] { arrayOfInt1, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, { 150, 28, 84, 41, 123, 158, 52, 156 }, arrayOfInt8, arrayOfInt9, arrayOfInt10, arrayOfInt11, { 109, 116, 137, 200, 178, 112, 125, 164 }, arrayOfInt12, { 134, 191, 151, 31, 93, 68, 204, 190 }, arrayOfInt13, arrayOfInt14, arrayOfInt15, arrayOfInt16, arrayOfInt17, arrayOfInt18, arrayOfInt19, arrayOfInt20 };
    arrayOfInt1 = new int[] { 0, 1, 1 };
    arrayOfInt2 = new int[] { 0, 2, 1, 3 };
    arrayOfInt3 = new int[] { 0, 4, 1, 3, 2 };
    arrayOfInt4 = new int[] { 0, 4, 1, 3, 3, 5 };
    arrayOfInt5 = new int[] { 0, 4, 1, 3, 4, 5, 5 };
    arrayOfInt6 = new int[] { 0, 0, 1, 1, 2, 2, 3, 4, 4 };
    arrayOfInt7 = new int[] { 0, 0, 1, 1, 2, 3, 3, 4, 4, 5, 5 };
    FINDER_PATTERN_SEQUENCES = new int[][] { { 0, 0 }, arrayOfInt1, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, { 0, 0, 1, 1, 2, 2, 3, 3 }, arrayOfInt6, { 0, 0, 1, 1, 2, 2, 3, 4, 5, 5 }, arrayOfInt7 };
  }
    ...
    throws NotFoundException
  {
    ...
    if (n > this.currentSequence.length) {
      throw NotFoundException.getNotFoundInstance();
    }
    int i = 0;
    ...
    this.currentSequence[(n - 1)] = paramFinderPattern.getValue();
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\zxing\oned\rss\expanded\RSSExpandedReader.class
