  ...
  extends AbstractDoCoMoResultParser
{
  ...
  public AddressBookParsedResult parse(Result paramResult)
  {
    ...
    return new AddressBookParsedResult(maybeWrap(paramResult), null, buildPhoneNumbers(str3, str4, str5), null, maybeWrap(str6), null, null, null, arrayOfString, null, str2, null, str1, null);
  }
}


/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\zxing\client\result\BizcardResultParser.class
