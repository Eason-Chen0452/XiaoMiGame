  ...
  private static String getMessage(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    if (n < paramInt1 + paramInt2)
    {
      ...
      for (;;)
      {
        ...
        localStringBuilder.append(NINE_DIGITS.format((i1 << 24) + (i2 << 18) + (i3 << 12) + (i4 << 6) + i5));
        continue;
        j = -1;
      }
    }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\zxing\maxicode\decoder\DecodedBitStreamParser.class
