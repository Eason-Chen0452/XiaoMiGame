...
public final class PDF417ScanningDecoder
{
  ...
  private static int adjustCodewordStartColumn(BitMatrix paramBitMatrix, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, int paramInt4)
  {
    ...
    else
    {
      for (;;)
      {
        if (((!paramBoolean) || (j < paramInt1)) && ((paramBoolean) || (j >= paramInt2) || (paramBoolean != paramBitMatrix.get(j, paramInt4)))) {
          break label91;
        }
  ...
  private static int[] getModuleBitCount(BitMatrix paramBitMatrix, int paramInt1, int paramInt2, boolean paramBoolean, int paramInt3, int paramInt4)
  {
    ...
    label115:
    if ((j == arrayOfInt.length) || (((paramBoolean) && (i == paramInt2)) || ((!paramBoolean) && (i == paramInt1) && (j == arrayOfInt.length - 1)))) {
      return arrayOfInt;
    }
    return null;
  }
...
/* Location:              C:\Users\Administrator\Desktop\apk\dex2jar\classes-dex2jar.jar!\com\google\zxing\pdf417\decoder\PDF417ScanningDecoder.class
